...
LOCAL_ONLY_REFERENCE_TRAINING_ALGORITHM_TOKEN: AlgorithmName = "LOCAL_ONLY_REFERENCE"  # TODO: should be enum
CENTRALIZED_REFERENCE_TRAINING_ALGORITHM_TOKEN: AlgorithmName = "CENTRALIZED_REFERENCE"  # TODO: should be enum
...
SOURCE_TRAINING_ALGORITHM_TOKEN: AlgorithmName = "SOURCE_CANDIDATE"  # TODO: should be enum
REPRODUCTION_TRAINING_ALGORITHM_TOKEN: AlgorithmName = "REPRODUCTION"  # TODO: should be enum
VERIFIER_AWARE_REPRODUCTION_TRAINING_ALGORITHM_TOKEN: AlgorithmName = "VERIFIER_AWARE_REPRODUCTION"  # TODO: should be enum
