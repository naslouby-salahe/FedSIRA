...
def test_equal_weight_domain_mean_requires_minimum_defined_domains() -> None:
    domain_results = (
        ...
        MetricResult(value=0.7, denominator=10),
    )
...
def test_worst_domain_target_f1_takes_minimum_defined() -> None:
    domain_results = (
        ...
        MetricResult(value=0.4, denominator=10),
        MetricResult(value=None, denominator=0),
    )
...
def test_worst_domain_target_f1_na_when_nothing_defined() -> None:
    assert worst_domain_target_f1((MetricResult(value=None, denominator=0),)).value is None


def test_percentile_10_domain_target_f1() -> None:
    domain_results = tuple(
        MetricResult(value=float(value), denominator=10) for value in range(1, 11)
    )
...
def test_interquartile_range() -> None:
    domain_results = tuple(
        MetricResult(value=float(value), denominator=10) for value in range(1, 9)
    )
...
def test_equal_weight_domain_mean_treats_each_domain_as_one_inference_unit() -> None:
    small_domain = MetricResult(value=0.5, denominator=3)
    large_domain = MetricResult(value=0.9, denominator=3000)
