...
ROADMAP_MODULES = frozenset(
    {
        ...
        "datasets/ciciot2023/prepare.py",
        "datasets/ciciot2023/schema.py",
        "datasets/ciciot2023/specification.py",
        "datasets/common.py",
        "datasets/nbaiot/__init__.py",
        "datasets/nbaiot/prepare.py",
        "datasets/nbaiot/schema.py",
        "datasets/nbaiot/specification.py",
        "datasets/preprocess.py",
        "datasets/specification.py",
        "domain/__init__.py",
        "domain/enums.py",
        "domain/models.py",
        "domain/types.py",
        "evaluation/__init__.py",
        "datasets/nbaiot/evaluation/__init__.py",
        "datasets/nbaiot/evaluation/backdoor.py",
        "datasets/nbaiot/evaluation/capability_boundary.py",
        "evaluation/comparisons.py",
        "datasets/nbaiot/evaluation/domain.py",
        "datasets/nbaiot/evaluation/epistemic_boundary.py",
        "evaluation/indexing.py",
        "evaluation/metrics.py",
        "datasets/nbaiot/evaluation/report_summary.py",
        "datasets/nbaiot/evaluation/screening.py",
        "datasets/nbaiot/evaluation/timing.py",
        "evaluation/service.py",
        "evaluation/statistics.py",
        "evaluation/standard.py",
        "evaluation/summaries.py",
        "experiments/__init__.py",
        "datasets/nbaiot/cell_support.py",
        "datasets/nbaiot/cells.py",
        "experiments/collapse.py",
        "experiments/definitions.py",
        "experiments/execution.py",
        "datasets/nbaiot/executor.py",
        "experiments/planning.py",
        "experiments/prerequisites.py",
        "datasets/nbaiot/scenarios.py",
        "datasets/nbaiot/validation.py",
        "datasets/nbaiot/workflow.py",
        "learning/__init__.py",
        "learning/aggregation.py",
        "learning/anchor.py",
        "datasets/nbaiot/learning/__init__.py",
        "datasets/nbaiot/learning/anchor_training.py",
        "learning/federated.py",
        "learning/model.py",
        "learning/post_reference.py",
        "datasets/nbaiot/learning/post_reference_training.py",
        "datasets/nbaiot/learning/reference.py",
        "learning/scoring.py",
        ...
        "datasets/nbaiot/baselines/__init__.py",
        "datasets/nbaiot/baselines/calibration.py",
        "datasets/nbaiot/baselines/certified_ensemble.py",
        "datasets/nbaiot/baselines/fedavg_training.py",
        "protocol/baselines/independent_retraining.py",
        "datasets/nbaiot/baselines/outcomes.py",
        "datasets/nbaiot/baselines/reconstruction_training.py",
        "protocol/baselines/references.py",
        "protocol/baselines/registry.py",
        "protocol/baselines/robust_aggregation.py",
        "datasets/nbaiot/baselines/robust_training.py",
        ...
        "reporting/project_evidence.py",
        "reporting/protocol_tables.py",
        "reporting/rendering.py",
        "reporting/tables.py",
